...
async function load_all_textnames(lang) {
    ...
    document.getElementById("label0").innerHTML = Textname["vtStandard"].vals[Settings.lang]
    document.getElementById("label1").innerHTML = Textname["vtTritanopia"].vals[Settings.lang]
    document.getElementById("label2").innerHTML = Textname["vtTritanomaly"].vals[Settings.lang]
    document.getElementById("label3").innerHTML = Textname["vtRedGreen"].vals[Settings.lang]
    document.getElementById("label4").innerHTML = Textname["vtMonochrome"].vals[Settings.lang]
    document.getElementById("menuTitle").innerHTML = Textname["visionTypes"].vals[Settings.lang]
}
...
function set_textname_regions() {
    ...
    do_textname(Textname.match1, btnARGB, false)
    do_textname(Textname.match2, btnARGB, false)
